...
def training_pipeline(examples: types.Channel,
                      schema: types.Channel) -> pipeline.Pipeline:
...
def validate_and_push_pipeline(examples: types.Channel, model: types.Channel,
                               serving_model_dir: str) -> pipeline.Pipeline:
  """An inputs-only test composable pipeline with conditional."""
  pipeline_inputs = pipeline.PipelineInputs({
      "examples": examples,
      "model": model
  })
  ...
  return pipeline.Pipeline(
      pipeline_name="validate_and_push_pipeline",
...
def create_test_pipeline():
  ...
  pipeline_name = "composable_pipeline"
