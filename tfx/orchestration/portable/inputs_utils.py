...
def _resolve_input_artifacts_with_resolver_config(
    metadata_handler: metadata.Metadata,
...
def _resolve_input_artifacts(
  ...
  """Resolve input artifacts from the pipeline node IR."""
...
def resolve_input_artifacts(
  ...
  if node_inputs.resolver_config.resolver_steps:
    resolved = _resolve_input_artifacts_with_resolver_config(
        metadata_handler, node_inputs)
  else:
    resolved = _resolve_input_artifacts(metadata_handler, node_inputs)
